...
# Use Cloudinary storage if credentials are provided or in production
if os.environ.get('CLOUDINARY_CLOUD_NAME') or os.environ.get('CLOUDINARY_URL') or (not DEBUG and not os.environ.get('USE_LOCAL_STORAGE')):
